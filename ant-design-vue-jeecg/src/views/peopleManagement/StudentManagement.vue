    ...
    <div class="table-page-search-wrapper">
      ...
      <a-form layout="inline" @keyup.enter.native="searchQuery">
        <a-row :gutter="24">
          <!-- 学生学号 -->
          <a-col :md="5" :sm="4">
            <a-form-item label="学号" :labelCol="{span: 5}" :wrapperCol="{span: 18, offset: 1}">
              <a-input placeholder="" v-model="queryParam.account" placeholder="请输入学生学号"></a-input>
            </a-form-item>
          </a-col>
          <!-- 学生姓名 -->
          <a-col :md="5" :sm="4">
          ...
          <template v-if="toggleSearchStatus">
            ...
            <!-- 学生专业 -->
            <a-col :md="5" :sm="4">
              <a-form-model-item label="学生专业" prop="major" >
                <major-select v-model="queryParam.majorId" placeholder="请输入学生专业" :options="majorData" dict="at_major,major_name,major_id" :pageSize="6" :async="true"/>
              </a-form-model-item>
            </a-col>
            <!-- 学生班级 -->
            <a-col :md="5" :sm="4">
              <a-form-model-item label="学生班级" prop="clazz" >
                <clazz-select v-model="queryParam.clazzId" placeholder="请输入学生班级" :options="clazzData" dict="at_clazz,clazz_name,clazz_id" :pageSize="6" :async="true"/>
              </a-form-model-item>
            </a-col>
            <!-- 学生手机号 -->
            <a-col :md="5" :sm="4">
              <a-form-item label="手机号" :labelCol="{span: 5}" :wrapperCol="{span: 18, offset: 1}">
                <a-input placeholder="" v-model="queryParam.phone" placeholder="请输入学生手机号"></a-input>
              </a-form-item>
            </a-col>
          </template>
        <a-col :md="6" :sm="8">
